...
public class Ball implements InputProcessor {
    ...
    private final unconventional.gamezcore.screens.PlayScreen playScreen;
    ...
    public Ball(World world, unconventional.gamezcore.screens.PlayScreen playScreen, Vector2 pos) {
        this.world = world;
        this.pos = pos;
        this.sb = unconventional.gamezcore.game.GameApp.APP.getSb();
    ...
    private void initParticleEffect() {
        ...
        effect.load(Gdx.files.internal("Particles/ballTail2.p"), unconventional.gamezcore.handlers.Res.textureAtlas);
        ...
        effect2.load(Gdx.files.internal("Particles/ballTail2.p"), unconventional.gamezcore.handlers.Res.textureAtlas);
    ...
    private void updateSpeed() {
            timeToTravel1Depth = unconventional.gamezcore.handlers.Cons.TIME_TO_TRAVEL_1_DEPTH - playScreen.getPlaySpeed() * 300; // 6 seconds
    ...
    public void render() {
        ...
        sb.draw(unconventional.gamezcore.handlers.Res.playerRegion, body.getPosition().x * unconventional.gamezcore.handlers.Cons.PPM - TotalCurrentRadius,
